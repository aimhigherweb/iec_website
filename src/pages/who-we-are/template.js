            ...
            <div className="intro-section__wrap">
              ...
              <div className="intro-section__row">
                <div className="intro-section__col intro-section__col_content">
                  <p><b>We are a team of industry leaders.</b> As practitioners, we firmly believe in
                    comprehensive care. As innovators, we provide this care with the most up-to-date
                    technology, knowledge, products and services available. As people, we value each one of
                    our patients and their individual needs.</p>
                  <p>Our practice is proudly independent and South Australian owned and operated. Part of a
                    long legacy of optometry in Adelaide and surrounds, we welcome generations of family
                    members as they continue in our care.</p>
                    ...
                    <div className="employee-slide__row">
                      <div className="employee-slide__col employee-slide__col-content">
                        <div className="employee-heading">
                          <h4>
                            {markdownRemark.frontmatter.jobtitle}
                          </h4>
                        </div>
                      ...
                      <div className="employee-slide__col employee-slide__col-sidebar">
                        ...
                        <ul className="progress-list">
                          <li>
                            <strong className="progress-list__label">{markdownRemark.frontmatter.skill1}</strong>
                            <div className="progressbar">
                              <span className="line" style={{width: markdownRemark.frontmatter.rating1 + '%'}}/>
                            </div>
                          </li>
                          <li>
                            <strong className="progress-list__label">{markdownRemark.frontmatter.skill2}</strong>
                            <div className="progressbar">
                              <span className="line" style={{width: markdownRemark.frontmatter.rating2 + '%'}}/>
                            </div>
                          </li>
                          <li>
                            <strong className="progress-list__label">{markdownRemark.frontmatter.skill3}</strong>
                            <div className="progressbar">
                              <span className="line" style={{width: markdownRemark.frontmatter.rating3 + '%'}}/>
                            </div>
                          </li>
                          <li>
                            <strong className="progress-list__label">{markdownRemark.frontmatter.skill4}</strong>
                            <div className="progressbar">
                              <span className="line" style={{width: markdownRemark.frontmatter.rating4 + '%'}}/>
                            </div>
                          </li>
                        </ul>
                      </div>

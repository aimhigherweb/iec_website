...
export default function(props) {
  ...
  return (
    <>
      ...
      <TopNav />
      <div
        className="content-section simple-section content-section--white-color
      ...
      >
        ...
        <div className="container">
          <div className="content-section__haeding">
            ...
            <h1 className="haeding__top-text top-text--small">
              Welcome to Innovative Eye Care
            </h1>
      ...
      <div className="content-section location-section">
        ...
        <div className="container">
          <div className="content-section__haeding">
            <h2>Our Locations</h2>
            Innovative Eye Care has two convenient locations in South Australia
            - Hutt Street, Adelaide and Port Road, Woodville.
          </div>
            ...
            <Link to="/what-we-do/contact-lenses">
              ...
              <div className="services__caption">
                <div className="services__wrap">
                  ...
                  <strong className="services__title">
            ...
            <Link to="/what-we-do/orthokeratology-corneal-reshaping">
              ...
              <div className="services__caption">
                <div className="services__wrap">
                  ...
                  <strong className="services__title">
                    ORTHO-K: <br /> Overnight vision correction
                  </strong>
                </div>
              </div>
            </Link>
              ...
              >
                <div className="employee-inner__rollover__box">
                  ...
                  <span className="position">
                    Therapeutic Optometrist BAppSc(Optom)Hons FIAO FCCLSA
                  </span>
      ...
      <div className="content-section simple-section content-section--white-color content-section--with-overlay blue--overlay text-center">
        ...
        <div className="container">
          <div className="content-section__haeding haeding--extra-large text-uppercase">
            <strong className="haeding__top-text">
              Inside out, back to front, on and off your eyes - we know <br />
              <strong className="large-text text-uppercase">
                CONTACT LENSES
              </strong>
            </strong>
          </div>
      ...
      <div className="content-section lenses-information content-section--white-color">
        ...
        <div className="container">
          <div className="container__wrap container--left-position">
            <div className="content-section__haeding">
              <strong className="haeding-top-text haeding--extra-large">
                Contact Lenses
              </strong>
            </div>
            <div className="lenses-holder">
              ...
              <dl className="lenses__list">
                ...
                <dd>
                  <span>RIGID GAS PERMEABLE (RGP)</span>
                </dd>
              </dl>
        ...
        <div className="container">
          <div className="container__wrap container--left-position">
            ...
            <ul className="symptoms-list same-height">
              <li>
                <div className="hold">
                  <strong className="symptoms__label">
                    Symptoms <br /> Include:
                  </strong>
                </div>
              </li>
              <li>
                <div className="hold">
                  ...
                  <strong className="symptoms__title">
                    STINGING &amp; BURNING
                  </strong>
                </div>
              </li>
      ...
      <div className="content-section simple-section content-section--white-color content-section--with-overlay blue--overlay text-center">
        ...
        <div className="container">
          <div className="content-section__haeding haeding--extra-large text-uppercase">
            <strong className="haeding__top-text">
              Dry eye disease reduces quality of life as much as angina
            </strong>
          </div>
        </div>
      </div>
      <div className="eye-problems-section blue-bg content-section--white-color text-center">
        <div className="container">
          ...
          <div className="ipl__footer">
            <strong className="idl__promo-text">
              The good news is, dry eye disease can be treated.
            </strong>
            <a
              href="http://www.tearfilm.org/dewsreport/pdfs/The%20Epidemiology%20of%20Dry%20Eye%20Disease.pdf"
        ...
        <div className="container">
          <div className="content-section__haeding haeding__with-extra-border heading--small-font">
            ...
            <div className="heading__wrap">
              <p>
                IPL for dry eye disease is revolutionary. Our E-Eye IPL machine
                generates flashes of homogenous light to the skin around the
                eyelid, stimulating glands to produce healthy tear film.
              </p>
            </div>
          </div>
          <strong className="ipl-section__sub-heading">
            We are the first practice in South Australia to offer IPL treatment
            for dry eye disease
          </strong>
          <div className="three-columns same-height">
            <div className="three-columns__item">
              ...
              <strong className="roundered__title height blue-color">
                DRY EYE RELIEF
              </strong>
            ...
            <div className="three-columns__item">
              ...
              <p>
                Accumulate the benefits - relief lasts longer after each
                treament
              </p>
            </div>
            <div className="three-columns__item">
      ...
      <div className="content-section eye-care-section content-section--white-color content-section--with-overlay black--overlay text-center">
        ...
        <div className="container">
          <div className="content-section__haeding haeding--extra-large text-uppercase">
            <strong className="haeding__sub-text">
              Eye care is not what it used to be.
            </strong>
            <strong className="haeding-top-text haeding--extra-large">
              It&apos;s better
            </strong>
          </div>
          <strong className="ipl-section__sub-heading full-width">
            Technology today means we can find out more about your eyes than
            ever before. Our equipment includes:
          </strong>
          <div className="three-columns same-height">
            <div className="three-columns__item">
              ...
              <strong className="roundered__title height">
          ...
          <div className="address-information">
            ...
            <div className="address__description container__wrap">
              ...
              <ul className="address__list">
                <li>
                  <i className="icon-location" /> We’re independent and South
                  Australian owned and operated.
                </li>
                <li>
                  <i className="icon-hands" /> Supporting local business is
                  important to us.
                </li>
                <li>
                  <i className="icon-smile" />
                  We’re part of something great, and we’re proud of it.
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="content-section subscribe-section content-section--with-overlay blue--overlay content-section--white-color">
        ...
        />
        <div className="container">
          <div className="content-section__haeding haeding--large-heading haeding--without-border haeding--medium-font">
            <strong className="haeding-top-text haeding--extra-large">
              Keep in Touch
            </strong>
            <p>
              We keep our finger on the pulse of the latest advances in eye
              care. Stay up to date with your eyes, plus be the first to hear
              about discounts on spectacles, sunglasses and solutions.
            </p>
            <strong className="content-section__add-heding">
              We will even make it interesting
            </strong>
            <div
      ...
      <div className="content-section join-section content-section--gray">
        ...
        <div className="container">
          <div className="content-section__haeding haeding--large-heading haeding--without-border">
            ...
            <strong className="content-section__sub-heding">

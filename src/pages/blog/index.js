          ...
          <div className="intro-section__wrap">
            ...
            <div className="intro-section__row">
              <div className="intro-section__col intro-section__col_content">
                <p>
                  The optometrists of Innovative Eye Care have a wide scope of
                  expertise. Our blog provides a platform for our practitioners
                  and staff to share a little more about their professional
                  interests and experiences. As well as some weird and wonderful
                  case studies, you’ll be kept up to date with practice news,
                  the latest research and treatment options, products we love
                  and fashion trends in our retail space.
                </p>
              </div>
            </div>
          </div>
            ...
            return (
              <li className="blog-post-box" key={i}>
                <Link to={`/blog/${node.parent.name}`}>
                  ...
                  <div className="blog-list__preview">{node.excerpt}</div>

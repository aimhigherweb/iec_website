...
function fixCaptions() {          
    $("p:contains('CAPTION:')" ).each(function() {
        var caption = $(this);
...
function initOpenClose() {
	jQuery('.open-close').openClose({
		...
		animStart: function(obj) {
		   ...
		   var holderOffset = self.holder.offset().left;
		   var parentOffset = self.holder.closest('.team-list').offset().left;
		   var newMargin = holderOffset - parentOffset ;
		   var newWidth = self.holder.closest('.team-list').outerWidth();
